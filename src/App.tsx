      ...
      <BrowserRouter>
        <div className="relative w-screen min-h-screen overflow-x-hidden bg-[#050508] text-white font-sans">
          ...
          <div className="relative z-10 flex flex-col min-h-screen">
            <a 
              href="#main-content" 
              className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-[100] px-4 py-2 bg-yellow-400 text-black font-bold rounded-full"
            >
          ...
          <footer className="relative w-full h-44 border-t border-white/5 bg-[#050508] overflow-hidden mt-12 flex items-center justify-center">
            <div className="absolute inset-0 flex justify-center pointer-events-none opacity-[0.03] select-none">
              <svg aria-hidden="true" className="w-full max-w-4xl h-full" viewBox="0 0 800 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="text-center relative z-10 text-[9px] font-mono tracking-[0.2em] text-white/50 uppercase select-none">
